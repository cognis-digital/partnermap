...
[![PyPI](https://img.shields.io/pypi/v/cognis-partnermap.svg)](https://pypi.org/project/cognis-partnermap/)
[![CI](https://github.com/cognis-digital/partnermap/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/partnermap/actions)
...
PARTNERMAP exists for one job — track partnership/channel agreements as yaml records and compute account overlap, co-sell coverage gaps, and renewal/expiry alerts. — and does it without a SaaS bill or heavyweight setup.
...
```bash
partnermap --version
partnermap scan .                      # scan the current project
partnermap scan . --format json
partnermap scan . --fail-on high       # non-zero exit for CI gates
partnermap mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Crossbeam/Reveal account mapping, as a local CLI**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`partnermap` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
