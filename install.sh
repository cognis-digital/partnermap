#!/usr/bin/env sh
# Universal installer for partnermap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/partnermap.git"
echo "Installing partnermap ..."
